...
const information = computed(() => [
  {
    title: messages.value[locale.value].projects.title_project.research.title,
    subtitle: messages.value[locale.value].projects.title_project.research.subtitle,
    p1: messages.value[locale.value].projects.title_project.research.paragraphs.p1,
    p2: messages.value[locale.value].projects.title_project.research.paragraphs.p2,
  }
]);
...
<template>
  <div class="project-page-container">
    ...
    <section class="project-impact-section">
      <h2 class="section-title">{{ messages[locale].projects.title_project.research.impacts_section.title }}</h2>
