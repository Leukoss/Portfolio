...
const information = computed(() => [
  {
    title: t('projects.title_project.tptrm.title'),
    subtitle: t('projects.title_project.tptrm.subtitle'),
    p1: t('projects.title_project.tptrm.paragraphs.p1'),
    p2: t('projects.title_project.tptrm.paragraphs.p2'),
  }
]);
...
<template>
  <div class="project-page-container">
    ...
    <section class="project-impact-section">
      <h2 class="section-title">{{ t('projects.title_project.tptrm.impacts_section.title') }}</h2>
